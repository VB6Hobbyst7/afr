...
Sub Class_Globals
	...
	Public ongoing1 As Boolean = True
End Sub
...
Public Sub setOngoing1 As NB6
	If IsOld Then
		OldNotification.OnGoingEvent = ongoing1
	Else
		NotificationBuilder.RunMethod("setOngoing", Array(ongoing1))
	End If
	Return Me
End Sub