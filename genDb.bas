...
Public Sub genStoredSongTable
	...
	Dim curs As Cursor	= vSql.ExecQuery(vQry)
	curs.Position = 0
	Starter.clsFunc.showLog("COUNT IS " & curs.GetInt("tel"), 0)
	curs.Close
End Sub
...
Sub addStationToPreset(setStname As String, setDescription As String, setGenre As String, setCountry As String, setLanguage As String, setUrl As String, stationId As String) As String
