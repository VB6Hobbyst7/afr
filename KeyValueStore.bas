...
Sub Class_Globals
	Private sql1 As SQL
	Private tempFolder = Starter.irp_dbFolder, tempFile = "key_value_temp.dat" As String
End Sub

'Initializes the store and sets the store file.
Public Sub Initialize (Dir As String, FileName As String, Create As Boolean)
...
Public Sub PutSong(Key As String, Value As Object) As Boolean
	Try
